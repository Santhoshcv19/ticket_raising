...
mixin _$FileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<PlatformFile>? data) file,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<PlatformFile>? data)? file,
...
abstract class _$$FileStateFileImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PlatformFile>? data});
}
...
class _$FileStateFileImpl implements _FileStateFile {
  const _$FileStateFileImpl({final List<PlatformFile>? data}) : _data = data;

  final List<PlatformFile>? _data;
  @override
  List<PlatformFile>? get data {
    final value = _data;
...
abstract class _FileStateFile implements FileState {
  const factory _FileStateFile({final List<PlatformFile>? data}) =
      _$FileStateFileImpl;
